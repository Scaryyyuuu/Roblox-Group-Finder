...
#your webhook
hook = input("[https://discord.com/api/webhooks/1214281601249452072/_uBO-IKeidr2u0sckEcmUezjt9rQgqb8oAXHirm6TwWpCUYT2sx5SiR0diEsj59ZlEUr] Enter your webhook url: "))
#number of threads
threads = int(input("[100] How many threads: "))
